...
import { apiGetSalaryStats, apiGetDepartmentStats } from "./lookup";
...
export function SalaryStats() {
  ...
  return <div id="chartdiv1" style={{ width: "100%", height: "1000px" }}></div>;
}
...
export function DepartmentStats() {
  ...
  useLayoutEffect(() => {
    ...
    if (statsDidSet === false) {
      ...
      apiGetDepartmentStats(handleStatsRefresh);
    }
    console.log(stats);
  ...
  return <div id="chartdiv2" style={{ width: "100%", height: "1000px" }}></div>;
}
